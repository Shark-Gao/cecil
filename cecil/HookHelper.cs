...
namespace ET {
	public class HookHelper {
		...
		static List<string> assemblyPathss = new List<string> () {
			// Application.dataPath+"/../Library/ScriptAssemblies/Unity.Model.dll", 
			// Application.dataPath+"/../Library/ScriptAssemblies/Unity.ModelView.dll", 
			Application.dataPath + "/../Library/ScriptAssemblies/Unity.Hotfix.dll", Application.dataPath + "/../Library/ScriptAssemblies/Unity.HotfixView.dll", Application.dataPath + "/../Library/ScriptAssemblies/Assembly-CSharp.dll",
		};
